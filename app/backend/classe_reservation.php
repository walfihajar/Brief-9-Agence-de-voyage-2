...
class Reservation 
{
    ...
    public function __construct(DatabaseManager $dbManager, int $id_reservation, int $id_user ='', int $id_activite ='' , Statut $statut ='', ?string $date_reservation ='', ?string $archive = '0')
    {
    ...
    {
        return $this->dbManager->selectAll('reservation','id_reservation = ?',[$this->id_reservation]);
    }
